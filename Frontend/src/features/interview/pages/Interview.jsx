...
const Interview = () => {
    ...
    const { report, getReportById, loading, loadingMessage, error, setError, getResumePdf, toggleStar } = useInterview()
            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    <div className="interview-nav__actions">
                        ...
                        <button
                            onClick={() => { toggleStar(interviewId, report?.isStarred) }}
                            className={`star-toggle-btn ${report?.isStarred ? 'starred' : ''}`} >
                            <svg height={"0.8rem"} style={{ marginRight: "0.8rem" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={report?.isStarred ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                            {report?.isStarred ? 'Starred Plan' : 'Star Plan'}
                        </button>
                    </div>
                </nav>
