...
- Name: interview.spec.js >> Interview Preparation App E2E Tests >> should display error screen if strategy generation fails
- Location: tests/interview.spec.js:69:3
...
Call log:
  - waiting for locator('.panel--left textarea')
    - locator resolved to <textarea maxlength="5000" class="panel__textarea" placeholder="Paste the full job description here...↵e.g. 'Senior Frontend Engineer at Google requires proficiency in React, TypeScript, and large-scale system design...'"></textarea>
    - fill("fail")
...
- main [ref=e3]:
  - generic [ref=e10]:
    - heading "Loading Dashboard" [level=2] [ref=e11]
    - paragraph [ref=e12]: Retrieving your recent interview preparation plans...
```
